    ...
    <div class="fixed bottom-0 w-full lg:w-20 lg:h-full z-10">
        <div class="w-full lg:w-20 h-full bg-blue-900 relative">
            ...
            <div class="flex lg:flex-col items-center justify-center h-full space-x-8 lg:space-x-0 lg:space-y-4 py-2 lg:py-4">
                ...
                <div class="group">
                    <NuxtLink to="messagerie" :class="isActive02 ? 'nav-link-active' : 'nav-link'">
                        <div >
                ...
                <div class="group">
                    <NuxtLink to="/statistiques" :class="isActive03 ? 'nav-link-active' : 'nav-link'">
                        <div>
                ...
                <div class="group">
                    <NuxtLink to="/calendrier" :class="isActive04 ? 'nav-link-active' : 'nav-link'">
                        <div>
